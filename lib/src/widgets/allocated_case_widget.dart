...
class AllocatedCaseWidget extends StatefulWidget {
  @override
  _AllocatedCaseWidgetState createState() => _AllocatedCaseWidgetState();
}

class _AllocatedCaseWidgetState extends State<AllocatedCaseWidget> {
