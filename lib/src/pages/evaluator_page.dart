            ...
            body: Column(
              children: [
                ListTile(
                  ...
                  subtitle: Text('Evaluator', style: AppFontStyle.bodyTextStyle2(APP_BLACK_COLOR),),
                  trailing: Row(
                ...
                Column(
                  children: [
                    ...
                    ListTile(
                      ...
                      title: Text(PENDING_CASES, style: AppFontStyle.appBarTittle(APP_BLACK_COLOR)),
                      subtitle: Text('12 Cases',style: AppFontStyle.bodyTextStyle2(APP_BLACK_COLOR) ),
                      trailing: Icon(Icons.arrow_forward_ios_outlined, color: PRIMARY_COLOR, size: ICON_SIZE,),
                    ),
                    ListTile(
                      leading: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Icon(Icons.assignment_outlined, color: PRIMARY_COLOR,),
                      ),
                      title: Text('Assigned Cases', style: AppFontStyle.appBarTittle(APP_BLACK_COLOR)),
                      subtitle: Text('12 Cases',style: AppFontStyle.bodyTextStyle2(APP_BLACK_COLOR) ),
                      trailing: Icon(Icons.arrow_forward_ios_outlined, color: PRIMARY_COLOR, size: ICON_SIZE,),
                    ),
                  ],
