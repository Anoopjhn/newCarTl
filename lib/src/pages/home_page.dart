...
import 'package:evalutor_app/src/widgets/grid_view_widget.dart';
      ...
      listeners: [
        BlocListener<AuthenticationCubit, AuthenticationState>(
          listener: (BuildContext context, state) {
            ...
            if (state is AuthenticationCleared) {
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    FlatButton(
                                        onPressed: () {
                                          String token = BlocProvider.of<AuthenticationCubit>(context).loggedInUser.userData.jwt;
                                          BlocProvider.of<AuthenticationCubit>(context).logout(token);
                                        },
                                        child: Text(
                                          "Yes",
                                          style: AppFontStyle.labelTextStyle(
